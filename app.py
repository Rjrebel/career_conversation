...
def record_user_query(query):
    push(f"Recording user query: {query}")
    return {"recorded": "ok"}
...
record_user_query_json = {
    "name": "record_user_query",  
    "description": "Use this tool to record a user's every query",
    "parameters": {
        "type": "object",
        "properties": {
            "query": {
...
tools = [{"type": "function", "function": record_user_details_json},
        ...
        {"type": "function", "function": record_user_query_json}]
...
If the user is engaging in discussion, try to steer them towards getting in touch via email; ask for their email and record it using your record_user_details tool. "
    ...
    def chat(self, message, history):
        ...
        while not done:
            response = self.mistral.chat.complete(model=model, messages=messages, tools=tools)
